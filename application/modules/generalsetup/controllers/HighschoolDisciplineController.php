...
class GeneralSetup_HighschoolDisciplineController extends Zend_Controller_Action {
	...
	public function detailAction(){
    	...
    	if($code){
			...
			$this->_redirect($this->view->url(array('module'=>'generalsetup','controller'=>'highschool-discipline', 'action'=>'index'),'default',true));
		}
    }
	...
	public function addAction()
    {
    	...
    	$form->cancel->onClick = "window.location ='".$this->view->url(array('module'=>'generalsetup','controller'=>'highschool-discipline', 'action'=>'index'),'default',true)."'; return false;";
		...
		if ($this->getRequest()->isPost()) {
			...
			if ($form->isValid($formData)) {
				...
				//redirect
				$this->_redirect($this->view->url(array('module'=>'generalsetup','controller'=>'highschool-discipline', 'action'=>'detail', 'code'=>$code),'default',true));	
			}else{
	...
	public function editAction(){
    	...
    	if ($this->getRequest()->isPost()) {
	    	...
	    	if ($form->isValid($formData)) {
				...
				$this->_redirect($this->view->url(array('module'=>'generalsetup','controller'=>'highschool-discipline', 'action'=>'detail', 'code'=>$formData['smd_code']),'default',true)); 
			}else{
				$form->populate($formData);	
			}
    	}else{
