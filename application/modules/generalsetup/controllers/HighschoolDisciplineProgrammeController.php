...
class GeneralSetup_HighschoolDisciplineProgrammeController extends Zend_Controller_Action {
	...
	public function detailAction(){
    	...
    	if($code){
    		...
    		$disciplineProgramme = $this->_DbObj->getDisciplineDataAll($discipline['smd_code']);
    		$this->view->disciplineProgramme = $disciplineProgramme;
    					
		}else{
			$this->_redirect($this->view->url(array('module'=>'generalsetup','controller'=>'highschool-discipline-programme', 'action'=>'index'),'default',true));
		}
    }
	...
	public function addAction()
    {
    	...
    	$form->cancel->onClick = "window.location ='".$this->view->url(array('module'=>'generalsetup','controller'=>'highschool-discipline-programme', 'action'=>'detail', 'code'=>$code),'default',true)."'; return false;";
		...
		if ($this->getRequest()->isPost()) {
			...
			if ($form->isValid($formData)) {
				...
				//redirect
				$this->_redirect($this->view->url(array('module'=>'generalsetup','controller'=>'highschool-discipline-programme', 'action'=>'detail', 'code'=>$code),'default',true));	
			}else{
	...
	public function deleteAction($id = null){
    	...
    	$this->_redirect($this->view->url(array('module'=>'generalsetup','controller'=>'highschool-discipline-programme', 'action'=>'detail', 'code'=>$data['apr_decipline_code']),'default',true));
