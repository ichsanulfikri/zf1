...
class GeneralSetup_HighschoolDisciplineSubjectController extends Zend_Controller_Action {
	...
	public function detailAction(){
    	...
    	if($code){
			...
			$this->_redirect($this->view->url(array('module'=>'generalsetup','controller'=>'highschool-discipline-subject', 'action'=>'index'),'default',true));
		}
    }
	...
	public function addAction()
    {
    	...
    	$form->cancel->onClick = "window.location ='".$this->view->url(array('module'=>'generalsetup','controller'=>'highschool-discipline-subject', 'action'=>'detail', 'code'=>$code),'default',true)."'; return false;";
		...
		if ($this->getRequest()->isPost()) {
			...
			if ($form->isValid($formData)) {
				...
				//redirect
				$this->_redirect($this->view->url(array('module'=>'generalsetup','controller'=>'highschool-discipline-subject', 'action'=>'detail', 'code'=>$code),'default',true));	
			}else{
	...
	public function deleteAction($id = null){
    	...
    	$this->_redirect($this->view->url(array('module'=>'generalsetup','controller'=>'highschool-discipline-subject', 'action'=>'detail', 'code'=>$data['sds_discipline_code']),'default',true));
