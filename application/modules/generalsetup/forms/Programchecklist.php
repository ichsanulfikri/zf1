<?php
class GeneralSetup_Form_Programchecklist extends Zend_Dojo_Form {
    ...
    public function init(){			
		...
		$CheckListName = new Zend_Form_Element_Text('CheckListName');
		$CheckListName  ->setAttrib('dojoType',"dijit.form.ValidationTextBox")  
        ...
        $this->addElements(
						array(
							$IdProgram,$CheckListName,$Description,
