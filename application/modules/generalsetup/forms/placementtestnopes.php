<?php
class GeneralSetup_Form_placementtestnopes extends Zend_Dojo_Form { //Formclass for the user module
    public function init() {
        ...
        $this->addElements(array($Year,$Apptype,$EnterNo,$Generate,$Search));
