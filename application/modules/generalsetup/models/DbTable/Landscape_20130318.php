...
class GeneralSetup_Model_DbTable_Landscape extends Zend_Db_Table_Abstract
{
	...
	public function fnUpdateMainLandscape($IdLandscape,$idstartsemester,$description,$AddDrop,$landscapeDefaultLanguage) {  // function to update po details
		$db = Zend_Db_Table::getDefaultAdapter();
		$table = "tbl_landscape";
		$larrupdate = array('IdStartSemester'=>$idstartsemester,'ProgramDescription'=>$description,'AddDrop'=>$AddDrop,'landscapeDefaultLanguage'=>$landscapeDefaultLanguage);
      ...
      */
        ...
        public function fnGetcoursesByScheme($studentId){
            ...
            $lstrSelect = $this->lobjDbAdpt->select()                         
                          ...
                          ->joinLeft(array("d"=>"tbl_subjectmaster"),"c.IdSubject = d.IdSubject",array("key" => "d.IdSubject","name" => "d.SubjectName"))
